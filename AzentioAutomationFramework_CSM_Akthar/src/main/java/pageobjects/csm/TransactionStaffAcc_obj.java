...
public class TransactionStaffAcc_obj {
	...
	public WebElement transactionExistingdata()
	{
	...
	@FindBy(xpath="//td[@id='td_transactionTypesList_GridTbl_Id_P024P_2_ctstrxtypeVO.CODE']")
	...
	private WebElement Transactiontype_Appscrn_Existingdata;
	public WebElement TransactiontypeAppscrnExistingdata()
	{
		return Transactiontype_Appscrn_Existingdata;
	}
