...
public class CSM_AmendChequeCardStatusSteps extends BaseClass {
	...
	CSM_TransactionObj_614 transactionObj = new CSM_TransactionObj_614(driver);
	...
	public void search_the_cheque_code_for_to_be_destroyed_cheque_code() throws Throwable {
		...
		chequeBookRequestObj.toBeDestroySearchChequeCode().sendKeys(testData.get("ChequeBookCode"));
	...
	public void search_for_destroy_record_cheque_code() throws Throwable {
		...
		chequeBookRequestObj.destroyChequeCodeSearch().sendKeys(testData.get("ChequeBookCode"));
