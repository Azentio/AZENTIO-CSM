...
public class CSMLogin_614 {
	...
	public CSMLogin_614(WebDriver driver) {
		this.driver = driver;
	}
	...
	public void loginIntoSadsApplication2() {
		csmLoginTestData = sadsLoginExceldata.getTestdata("Sadsuser2");
		csmCommonWebElements = new CSMCommonWebElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, csmCommonWebElements.csmUserName());
		csmCommonWebElements.csmUserName().click();
	...
	public void loginIntoCSMApplicationVimal() {
		csmLoginTestData = csmLoginExceldata.getTestdata("CSMUser3");
		csmCommonWebElements = new CSMCommonWebElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, csmCommonWebElements.csmUserName());
		csmCommonWebElements.csmUserName().click();
	...
	public void loginIntoCSMParamApplicationVimal() {
		csmLoginTestData = csmParamLoginTestData.getTestdata("CSMParamUser3");
		csmCommonWebElements = new CSMCommonWebElements(driver);
		clicksAndActionHelper = new ClicksAndActionsHelper(driver);
		waitHelper.waitForElementwithFluentwait(driver, csmCommonWebElements.csmUserName());
		csmCommonWebElements.csmUserName().click();
