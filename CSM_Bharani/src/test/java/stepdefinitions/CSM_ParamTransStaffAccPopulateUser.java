...
public class CSM_ParamTransStaffAccPopulateUser {
	...
	// "\\TestData\\CSMparamTestData.xlsx";
	// ExcelData excelData = new ExcelData(TestDataPath, "Accounts Restriction",
	// "Data Set ID");
	...
	public void enter_the_code_value_under_populate_user_maintenance_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.Maintenance_CodeBox().sendKeys("643");
	...
	public void enter_the_brief_description_valuse_under_populate_user_maintenance_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.Maintenance_BreifDes().sendKeys("643");
	}
	...
	public void enter_the_long_description_valuse_under_populate_user_maintenance_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.Maintenance_LongDes().sendKeys("643");
	}
	...
	public void enter_the_brief_description_arabic_values_under_populate_user_maintenance_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.BreiefDes_Arabic().sendKeys("643");
	}
	...
	public void enter_the_long_description_arabic_valuse_under_populate_user_maintenance_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.LongDes_Arabic().sendKeys("643");
	}
	...
	public void click_the_ok_popup_under_the_success_popup() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				transStaffAccPopulateUSerObj.OkPopup_SuccessScreenMaintenance());
	...
	public void enter_the_population_code_under_populate_screen() throws Throwable {
		...
		transStaffAccPopulateUSerObj.Populate_FlagCode().sendKeys("643");
	...
	public void enter_the_approve_code_under_approve_flag() throws Throwable {
		...
		transStaffAccPopulateUSerObj.Approve_Code().sendKeys("643");
	...
	public void click_on_approve_button_in_populate_user() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, transStaffAccPopulateUSerObj.ApproveCode_Approve());
		clicksAndActionsHelper.clickUsingActionClass(transStaffAccPopulateUSerObj.ApproveCode_Approve(),
				transStaffAccPopulateUSerObj.ApproveCode_Approve());
	...
	public void again_click_the_populate_flag_under_populate_user() throws Throwable {
		for (int j = 0; j < 300; j++) {
			...
			waitHelper.waitForElementwithFluentwait(driver,
					transStaffAccPopulateUSerObj.PopulateUser_PopulateFlag());
		clicksAndActionsHelper.moveToElement(transStaffAccPopulateUSerObj.PopulateUser_PopulateFlag());
		transStaffAccPopulateUSerObj.PopulateUser_PopulateFlag().click();
	}
		}

	@Then("^Click the ok popup for the populate user flag$")
	public void click_the_ok_popup_for_the_populate_user_flag() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, transStaffAccPopulateUSerObj.okpopup_ForPopulateScreen());
		clicksAndActionsHelper.moveToElement(transStaffAccPopulateUSerObj.okpopup_ForPopulateScreen());
		transStaffAccPopulateUSerObj.okpopup_ForPopulateScreen().click();
