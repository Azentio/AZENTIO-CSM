...
public class CSMCommonWebElements {
	...
	@FindBy(xpath = "//legend[@id='legend']")
	private WebElement csm_ForceLogout;
	
	public WebElement csm_ForceLogout() {
		return csm_ForceLogout;
	}
	
	@FindBy(xpath = "//span[text()=' Yes']")
	private WebElement csmForceLogoutYesButton;
	
	public WebElement csmForceLogoutYesButton() {
		return csmForceLogoutYesButton;
	}
