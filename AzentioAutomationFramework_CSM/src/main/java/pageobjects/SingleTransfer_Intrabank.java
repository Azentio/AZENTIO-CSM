...
public class SingleTransfer_Intrabank {
    WebDriver driver;
    public SingleTransfer_Intrabank(WebDriver driver) {
    	this.driver=driver;
    ...
    private WebElement AfterApprove;
    public WebElement AfterApprove() {
  	  return AfterApprove;
    }
...
//  	}
  ...
  private WebElement ChequeNumber_CSM072;
  public WebElement ChequeNumber_CSM072() {
  	return ChequeNumber_CSM072;
  }
  @FindBy(xpath="//input[@id='chq_date_D001MT']")
  private WebElement ChequeNumberDate_CSM72;
  public WebElement ChequeNumberDate_CSM72(){
  	return ChequeNumberDate_CSM72;
  }
  	}
