...
public class CashtransactionWarnlimit {
    ...
    @And("^User_72 Click Ok Button in Information PopUp menusss$")
    ...
    @And("^User_72 Click on Technical Details Icons$")
    ...
    public void user_click_on_transactions_under_csm_application() throws Throwable {
	 ...
	 @And("^User_72 Click on Maintenance under Transactions$")
	    ...
	    @And("^User_72 Click Ok Button in Warning PopUp Menus$")
	    ...
	    @And("^User_72 Enter the Currency in Maintenance Screenss$")
...
//	    }
	    ...
	    @And("^User_72 Click the Account Details in Maintenance Screenss$")
	    ...
	    @And("^User_72 Click Add button in AccountDetails$")
	    ...
	    @And("^User_72 Enter the Branch in AccountDetails$")
	    ...
	    @And("^User_72 Enter the Gl in AccountDetails$")
	    ...
	    @And("^user_72 Enetr the cif in AccountDetails$")
	    ...
	    @And("^User_72 Enter the Serial in AccountDetails$")
	    ...
	    @And("^User_72 Enter the Amount in AccountDetails$")
	    ...
	    @And("^User_72 give some Msg Instruction1 in AccountDetails$")
	    ...
	    @And("^User_72 give some Msg Instruction2 in AccountDetails$")
	    ...
	    @And("^User_72 Click the ok button in AccountDetails$")
...
//debit acount
        ...
        public void user_72_click_ok_button_in_warning_popup_menu() throws Throwable {
        ...
        public void user_72_enter_the_currency_in_maintenance_screen() throws Throwable {
...
//            for (int i = 0; i < 200; i++) {
                ...
                try {
                	...
                	CashDepositTransactionobj.CSMCurrencyInMaintenanceScreen().sendKeys(testData.get("CurrencyCode_D1"));

                	CashDepositTransactionobj.CSMCurrencyInMaintenanceScreen().sendKeys(Keys.TAB);
...
//        }  
	    ...
	    @And("^User_72 Click Ok Button in Information PopUp menu$")
	        ...
	        public void user_72_click_ok_button_in_information_popup_menu() throws Throwable {
	    ...
	    @And("^User_72 Click on Technical Details Icon$")
	        ...
	        public void user_72_click_on_technical_details_icon() throws Throwable {
