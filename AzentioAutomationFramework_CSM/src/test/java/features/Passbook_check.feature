Feature: Uers create the Passbook entry in CSM module
Scenario: User login to passbook details in CSM
...
#And User click on the Passbook code in CSM Module
#And User click on the Status in CSM Module
#And User click on the Branch Name in CSM Module
#And User click on the DataCreated in CSM Module 
