...
public class CSM_Chequebookrequest_step {
	...
	public void user_click_the_update_after_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove());
	...
	public void user_click_the_user_id_in_update_after_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
	...
	public void user_double_click_the_user_id() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid_doubleclick());
...
//    }
	...
	public void user_select_the_logged_in_branch() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch());
		...
		// dropDownHelper.SelectUsingVisibleText(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch(),"Logged-in
		// branch" );
		// dropDownHelper.SelectUsingVisibleText(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch(),
	...
	public void user_click_the_update_after_approve_button() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove());
		javascriptHelper.scrollIntoView(
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove());
	}
	...
	public void user_click_the_save_ok_button() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok());
		clicksAndActionsHelper.moveToElement(
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok());
	...
	public void user_click_the_ok() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				// waitHelper.waitForElementwithFluentwait(driver,
				// csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok_Ok());
				clicksAndActionsHelper.moveToElement(
						csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok_Ok());
				clicksAndActionsHelper.clickOnElement(
						csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch_Updateafterapprove_Ok_Ok());
	...
	public void user_double_click_the_user_id_in_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_User_Approve_Username_doubleclick());
	...
	public void user_click_the_approve_box() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_User_Approve_Username_doubleclick_Approve());
		for (int i = 0; i < 200; i++) {
			try {
	...
	public void user_click_the_send_toreceive_from_provider() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom());
	...
	public void user_click_the_send_to_provider_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider());
	}
	...
	public void user_click_the_retrive_button_in_send_to_provider() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_retrivebutton());
		clicksAndActionsHelper.moveToElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_retrivebutton());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_retrivebutton());
	...
	public void user_update_test_data_set_id_for_chb186d3() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_Inputfield());
		clicksAndActionsHelper.moveToElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_Inputfield());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_Senttoprovider_Inputfield());
	...
	public void user_click_the_receive_from_provider_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider());
	}
	...
	public void user_update_test_data_set_id_for_chb186d3_in_receive_from_provider_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider_Inputfield());
		clicksAndActionsHelper.moveToElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider_Inputfield());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmcore_ChequeBookRequest_senttoreceivefrom_recievefromprovider_Inputfield());
	...
	public void user_select_all_the_branch_in_dropdown() throws Throwable {
		...
		javascriptHelper.scrollIntoView(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch());
		// dropDownHelper.SelectUsingVisibleText(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch(),
		// testData.get("Send to receive from chequebooks dropdown") );
		dropDownHelper.SelectUsingVisibleText(csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch(),
				"Granted Locations");
		// waitHelper.waitForElementwithFluentwait(driver,
		// csmChequebookObject.csmParam_User_Userid_doubleclick_logintobranch());
	...
	public void user_update_test_data_set_id_for_trs024() throws Throwable {
		testData = excelDataForChequeBookRequest.getTestdata("CHB_180_D1");
	}
	...
	public void user_click_the_update_after_approve_screen_under_general_ledger() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_Updateafterapprove());
	...
	public void user_update_test_data_set_id_for_chb180_in_update_after_screen() throws Throwable {
		...
		csmChequebookObject.csmParam_General_ledger_code().sendKeys(testData.get("GLCode_D1"));
	...
	public void user_click_additional_details() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				clicksAndActionsHelper
						.moveToElement(csmChequebookObject.csmParam_General_ledger_code_additionaloptions());
				clicksAndActionsHelper
						.clickOnElement(csmChequebookObject.csmParam_General_ledger_code_additionaloptions());
				break;
			} catch (Exception e) {
				if (i == 199) {
					Assert.fail(e.getMessage());
	...
	public void user_change_the_value_as_notify_and_dont_proceed_in_drop_down() throws Throwable {
		...
		dropDownHelper.SelectUsingVisibleText(
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown(), "Notify and Proceed");
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown());
		dropDownHelper.SelectUsingVisibleText(
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown(),
				testData.get("DropDown"));
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown());
	}
...
//    }
	...
	public void user_update_test_data_set_id_for_chb180_in_approve() throws Throwable {
		// testData = excelDataForChequeBookRequest.getTestdata("CHB_180 _D3");
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_Approve_inputfield());
		clicksAndActionsHelper.moveToElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield());
		clicksAndActionsHelper.clickOnElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield());
		csmChequebookObject.csmParam_General_ledger_Approve_inputfield().sendKeys(testData.get("GLCode_D1"));
	...
	public void user_double_click_the_record_in_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick());
		// clicksAndActionsHelper.clickOnElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick());
		clicksAndActionsHelper
				.doubleClick(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick());
	}
	...
	public void user_click_the_approve_button_under_drop_down_menu() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve());
	...
	public void user_click_the_ok_button_on_information_popup() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve_OK());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve_OK());
		clicksAndActionsHelper.clickOnElement(
				csmChequebookObject.csmParam_General_ledger_Approve_inputfield_doubleclick_Approve_OK());
	}
	...
	public void user_click_the_updateafterapprove_menu_under_transationtype() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Transactiontype_Updateafterapprovefield());
...
//	}
	...
	public void user_double_click_the_record_under_updateafterapprove_screen() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver,
						csmChequebookObject.csmParam_Transactiontype_inputfield_doubleclick());
...
//        clicksAndActionsHelper.clickOnElement(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds());
		...
		if (csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds().getAttribute("initialvalue")
				.isBlank()) {
			clicksAndActionsHelper
					.moveToElement(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds());
	...
	public void user_click_updateafterapprove_button_under_updateafterapprove_field() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds_UPAbutton());
		javascriptHelper
				.scrollIntoView(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds_UPAbutton());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds_UPAbutton());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds_UPAbutton());
	}
	...
	public void user_enter_the_code_in_inputfield_on_approve_screen_under_transactiontype() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield());
	...
	public void user_double_click_the_record_approve_screen() throws Throwable {
		try {
			waitHelper.waitForElementwithFluentwait(driver,
					csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick());
			clicksAndActionsHelper
					.moveToElement(csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick());
			clicksAndActionsHelper
					.doubleClick(csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick());
		} catch (Exception e) {
			Assert.fail(e.getMessage());
		}
	...
	public void user_click_the_chequebookrequest_submenu_on_csmcore() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, csmChequebookObject.csmcore_Chequebookrequest());
		javascriptHelper.scrollIntoView(csmChequebookObject.csmcore_Chequebookrequest());
		clicksAndActionsHelper.moveToElement(csmChequebookObject.csmcore_Chequebookrequest());
		clicksAndActionsHelper.clickOnElement(csmChequebookObject.csmcore_Chequebookrequest());
	}
	...
	public void user_click_the_approve_button_on_approve_field() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick_Approve());
		javascriptHelper
				.scrollIntoView(csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick_Approve());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick_Approve());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmParam_Transactiontype_Approve_Inputfield_doubleclick_Approve());
	}
	...
	public void user_enter_the_code_on_chequebookrequest_maintanance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code());
		...
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code().sendKeys(testData.get("Cheque_code"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code().sendKeys(Keys.ENTER);
	}

	@Given("user Enter the NoOfCheques in the field")
	public void user_enter_the_no_of_cheques_in_the_field() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_NoofChequeBooks());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmcore_Chequebookrequest_maintanace_NoofChequeBooks());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmcore_Chequebookrequest_maintanace_NoofChequeBooks());
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_NoofChequeBooks().sendKeys(testData.get("code"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_NoofChequeBooks().sendKeys(Keys.TAB);
	}
...
//    }
	...
	public void user_enter_the_branchcode_on_chequebookrequest_maintenance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code_branchcode());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code_branchcode());
		clicksAndActionsHelper
				.clickOnElement(csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code_branchcode());
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code_branchcode()
				.sendKeys(testData.get("BranchCode_D1"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_Code_branchcode().sendKeys(Keys.TAB);
	}
	...
	public void user_enter_the_currencycode_on_chequebookrequest_maintenance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_currencyCode());
		...
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_currencyCode().sendKeys(Keys.TAB);
	}
	...
	public void user_enter_the_glcode_on_chequebookrequest_maintenance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_GLcode());
		...
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_GLcode().sendKeys(testData.get("GLCode_D1"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_GLcode().sendKeys(Keys.TAB);
	}
	...
	public void user_enter_the_cifcode_on_chequebookrequest_maintenance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_CIFCode());
		...
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_CIFCode().sendKeys(testData.get("CIFCode_D1"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_CIFCode().sendKeys(Keys.TAB);
	}
	...
	public void user_enter_the_serialno_on_chequebookrequest_maintance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_SerialNo());
		...
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_SerialNo().sendKeys(testData.get("SerialNo_D1"));
		csmChequebookObject.csmcore_Chequebookrequest_maintanace_SerialNo().sendKeys(Keys.TAB);
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_SaveButton());
	}
	...
	public void user_click_the_save_button_on_maintance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_maintanace_SaveButton());
		javascriptHelper.scrollIntoView(csmChequebookObject.csmcore_Chequebookrequest_maintanace_SaveButton());
	...
	public void user_click_the_approve_button_under_chequebookrequest_field() throws Throwable {
		...
		try {
			...
			javascriptHelper.scrollIntoView(csmChequebookObject.csmcore_Chequebookrequest_Approve());
	...
	public void user_enter_the_gl_code_on_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField());
		...
		csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField().sendKeys(testData.get("Cheque_code"));
		csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField().sendKeys(Keys.ENTER);
	}
	...
	public void user_double_click_the_gl_code_on_approve_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick());
		clicksAndActionsHelper
				.moveToElement(csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick());
		clicksAndActionsHelper
				.doubleClick(csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick());
	}
	...
	public void user_approve_the_gl_record_on_approve_field() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick_Approvebutton());
		javascriptHelper.scrollIntoView(
				csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick_Approvebutton());
		clicksAndActionsHelper.moveToElement(
				csmChequebookObject.csmcore_Chequebookrequest_Approve_InputField_doubleclick_Approvebutton());
	...
	@Given("User Enter the Date in User Running Date for CHB_{int}")
	public void user_enter_the_date_in_user_running_date_for_chb(Integer int1) throws IOException {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				csmChequebookObject.CSMDateInUserRunningDate());
		seleniumActions.getClickAndActionsHelper().moveToElement(csmChequebookObject.CSMDateInUserRunningDate());
		seleniumActions.getClickAndActionsHelper().clickOnElement(csmChequebookObject.CSMDateInUserRunningDate());
		csmChequebookObject.CSMDateInUserRunningDate().clear();
		csmChequebookObject.CSMDateInUserRunningDate().sendKeys("17/05/2023");
	}

	@Given("user validate the cannot Proceed Message")
	public void user_validate_the_cannot_proceed_message() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, csmChequebookObject.cannotProceedWarningPopUp());
		Assert.assertTrue(csmChequebookObject.cannotProceedWarningPopUp().isDisplayed());
	}

	// CHB_181
	@And("^user update test data set id for CHB_181$")
	public void user_update_test_data_set_id_for_CHB_181() throws Throwable {
		testData = excelDataForChequeBookRequest.getTestdata("CHB_181_D1");
	}
...
//        clicksAndActionsHelper.clickOnElement(csmChequebookObject.csmParam_Transactiontype_proceedoninsufficentfunds());
	...
	public void user_change_the_value_as_notify_and_proceed_in_drop_down() throws Throwable {
		javascriptHelper.scrollIntoView(csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown());
		dropDownHelper.SelectUsingVisibleText(
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown(),
				"Notify and Don't Proceed");
		waitHelper.waitForElementwithFluentwait(driver,
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown());
		dropDownHelper.SelectUsingVisibleText(
				csmChequebookObject.csmParam_General_ledger_code_additionaloptions_dropdown(),
	...
	// CHB_182
	@And("^user update test data set id for CHB_182$")
	public void user_update_test_data_set_id_for_CHB_182() throws Throwable {
		testData = excelDataForChequeBookRequest.getTestdata("CHB_182_D1");
	}
