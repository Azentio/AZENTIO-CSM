...
//	}
	...
	public void user_click_the_system_parameters_submenus() throws Throwable {
		
		
			javaScriptHelper.scrollIntoView(CSMTransactionObject.csmParam_Systemparameter());
			waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.csmParam_Systemparameter());					
			clicksAndActionsHelper.moveToElement(CSMTransactionObject.csmParam_Systemparameter());
			clicksAndActionsHelper.clickOnElement(CSMTransactionObject.csmParam_Systemparameter());
	...
	public void user_double_click_the_code_on_upaa_field() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMParam_TransactionType_UPA_code_doubleClick());
	...
	public void user_check_the_status_of_the_allowinternalglaccount_checkbox() throws Throwable {
		try {
			waitHelper.waitForElementwithFluentwait(driver,
					CSMTransactionObject.CSMParam_TransactionType_AllowInternalGL());
			if (CSMTransactionObject.CSMParam_TransactionType_AllowInternalGL().getAttribute("initialvalue")
					.isBlank()) {
	...
	public void user_click_updateafterapprove_button() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMParam_TransactionType_AllowInternalGL_UPAButton());
		...
		clicksAndActionsHelper
				.clickOnElement(CSMTransactionObject.CSMParam_TransactionType_AllowInternalGL_UPAButton());
	}
		...
		for (int i = 0; i < 200; i++) {
			try {
				 waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.CSMParam_TransactionType_Approve());		
					javascriptHelper.scrollIntoView(CSMTransactionObject.CSMParam_TransactionType_Approve());
	...
	public void user_double_click_the_code_on_approve_field() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver,
						CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick());
				// clicksAndActionsHelper.moveToElement(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick());
				clicksAndActionsHelper
						.doubleClick(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick());
				break;
		...
		public void user_double_click_the_code_on_approve_fieldforTRS_064() throws Throwable {
			for (int i = 0; i < 200; i++) {
				try {
					waitHelper.waitForElementwithFluentwait(driver,
							CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClickforTRS_064());
					// clicksAndActionsHelper.moveToElement(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick());
					clicksAndActionsHelper
							.doubleClick(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClickforTRS_064());
					break;
	...
	public void user_click_approve_button() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick_ApproveButton());
		clicksAndActionsHelper
				.moveToElement(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick_ApproveButton());
		clicksAndActionsHelper
				.clickOnElement(CSMTransactionObject.CSMParam_TransactionType_Approve_code_doubleClick_ApproveButton());
	}
	...
	public void user_enter_the_trxtype_on_maintance_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCore_Transactions_Maintenance_TRXType());
	...
	public void user_enter_the_branchcode_under_trxtype() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCore_Transactions_Maintenance_BranchCode());
	...
	public void user_enter_the_currencycode_under_trxtype() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCore_Transactions_Maintenance_CurrencyCode());
	...
	public void user_enter_the_cifcode_under_trxtype() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCore_Transactions_Maintenance_CIFCode());
	...
	public void user_enter_the_serialno_under_trxtype() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCore_Transactions_Maintenance_SerialNo());
	...
	public void user_enter_the_arabicword_no1_on_upaa_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMparam_transactionType_UPAA_Arabicword_No1());
	...
	public void user_enter_the_arabicword_no2_on_upaa_screen() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMparam_transactionType_UPAA_Arabicword_No2());
	...
	public void user_get_transaction_number_from_sucess_pop_upforTRS_027() throws Throwable {
		...
		excelDataForTransaction.updateTestData("TRS_027_D1", "TRXNo", transactionNo);
		testData = excelDataForTransaction.getTestdata("TRS_027_D1");
	}
...
//    }
	...
	public void user_click_the_user_id_in_update_after_approve_screens() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
		clicksAndActionsHelper
				.moveToElement(CSMTransactionObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
		clicksAndActionsHelper
				.clickOnElement(CSMTransactionObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid());
		// csmChequebookObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid().sendKeys(testData.get("User_Id"));
		CSMTransactionObject.csmParam_Systemparameter_User_UpadateAfterapprove_Userid()
				.sendKeys(testData.get("User_Id"));
	...
	public void system_show_the_warning_popup_clikc_ok_button() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				if (CSMTransactionObject.Transactions_Warning_okbtn().isDisplayed()) {
	...
	public void Enter_the_Amount_in_this_Checkbox_clicksomething() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.clicksomething());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.clicksomething());
		CSMTransactionObject.Transactions_EnterAmount().sendKeys(testData.get("Amount"));
		
		CSMTransactionObject.Transactions_EnterAmount().sendKeys(Keys.TAB);
	}

	@And("^user click the approve boxs$")
	public void user_click_the_approve_boxs() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.csmParam_User_Approve_Username_doubleclick_Approve());
		for (int i = 0; i < 200; i++) {
			try {
				
				clicksAndActionsHelper.moveToElement(CSMTransactionObject.csmParam_User_Approve_Username_doubleclick_Approve());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.csmParam_User_Approve_Username_doubleclick_Approve());
				break;
			} catch (Exception e) {
			if (i==199) {
				Assert.fail(e.getMessage());
...
//	}
	...
	public void user_Enters_the_transaction_number_forTRS_027() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.Transactions_transactionNo_codeValue2());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.Transactions_transactionNo_codeValue2());

		CSMTransactionObject.Transactions_transactionNo_codeValue2().sendKeys(testData.get("TRXNo"));
		CSMTransactionObject.Transactions_transactionNo_codeValue2().sendKeys(Keys.ENTER);
	...
	waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.transactionCloseTransactionTab());

	clicksAndActionsHelper.moveToElement(CSMTransactionObject.transactionCloseTransactionTab());

	clicksAndActionsHelper.clickOnElement(CSMTransactionObject.transactionCloseTransactionTab());
	...
	public void user_enters_the_transaction_number_forTRS_067() throws Throwable {
	...
	public void user_get_transaction_number_from_sucess_pop_upforTRS_067() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.getTransactionNumber());
		String transactionNo = CSMTransactionObject.getTransactionNumber().getText().substring(15, 19);
		System.out.println(transactionNo);
		excelDataForTransaction.updateTestData("TRS_067_D1", "TRXNo", transactionNo);
		testData = excelDataForTransaction.getTestdata("TRS_067_D1");
	}
...
//        clicksAndActionsHelper.clickOnElement(CSMTransactionObject.TransactionType_UPAA_dealwithCurrencyDominationChequbox());
		for (int i = 0; i < 200; i++) {
			try {
				javascriptHelper
						.scrollIntoView(CSMTransactionObject.TransactionType_UPAA_dealwithCurrencyDominationChequbox());
				waitHelper.waitForElementwithFluentwait(driver,
						CSMTransactionObject.TransactionType_UPAA_dealwithCurrencyDominationChequbox());
				if (CSMTransactionObject.TransactionType_UPAA_dealwithCurrencyDominationChequbox()
...
//    			Assert.fail(e.getMessage());
	...
	public void user_double_click_the_record_under_updateafterapprove_screen() throws Throwable {
		...
		waitHelper.waitForElementwithFluentwait(driver,
				CSMTransactionObject.csmParam_Transactiontype_inputfield_doubleclick());
	...
	public void user_enter_the_code_in_inputfield_on_updateafterapprove_screen_under_transactiontypeforTRS_026()
			throws Throwable {
	...
	public void user_enter_the_code_in_inputfield_on_updateafterapprove_screen_under_transactiontype_for_trs063()
			throws Throwable {
for (int i = 0; i < 200; i++) {
	try {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.csmParam_Transactiontype_inputfield());
...
if (i==199) {
	...
	public void user_double_click_the_record_under_updateafterapprove_screenforTRS_064() throws Throwable {
		for (int i = 0; i < 200; i++) {
			try {
				waitHelper.waitForElementwithFluentwait(driver,
						CSMTransactionObject.csmParam_Transactiontype_inputfield_doubleclickforTRS_064());
				clicksAndActionsHelper.moveToElement(CSMTransactionObject.csmParam_Transactiontype_inputfield_doubleclickforTRS_064());
				clicksAndActionsHelper.doubleClick(CSMTransactionObject.csmParam_Transactiontype_inputfield_doubleclickforTRS_064());
				break;
			} catch (Exception e) {
				if (i==199) {
					Assert.fail(e.getMessage());
...
//        }
	...
	public void user_enter_the_typecode_in_approve_field() throws Throwable {
		...
		CSMTransactionObject.csmParam_AccountParameters_AccountTypes_ApproveField_TypeCode()
				.sendKeys(testData.get("GLCode_D1"));
	...
	public void user_click_on_close_button_in_change_running_date_popups() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMCloseButtonInChangeRunningDate());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.CSMCloseButtonInChangeRunningDate());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.CSMCloseButtonInChangeRunningDate());
	}
	...
	public void user_enter_the_branchcode_under_trxtype_for_debitaccount() throws Throwable {
		...
		CSMTransactionObject.CSMCore_Transactions_Maintenance_BranchCodeForCredit()
	...
	public void user_enter_the_currencycode_under_trxtype_for_debitaccount() throws Throwable {
		...
		CSMTransactionObject.CSMCore_Transactions_Maintenance_CurrencyCodeCodeForCredit()
	...
	public void user_enter_the_cifcode_under_trxtype_for_debitaccount() throws Throwable {
		...
		CSMTransactionObject.CSMCore_Transactions_Maintenance_CIFCodeCodeForCredit()
	...
	public void user_enter_the_serialno_under_trxtype_for_debitaccount() throws Throwable {
		...
		CSMTransactionObject.CSMCore_Transactions_Maintenance_SerialNoCodeForCredit()
...
//   clicksAndActionsHelper.clickOnElement(CSMTransactionObject.csmParam_Transactiontype_proceedoninsufficentfunds());
		...
		if (CSMTransactionObject.csmParam_Transactiontype_proceedoninsufficentfunds().getAttribute("initialvalue")
				.isBlank()) {
			clicksAndActionsHelper
					.moveToElement(CSMTransactionObject.csmParam_Transactiontype_proceedoninsufficentfunds());
			clicksAndActionsHelper.clickUsingActionClass(
					CSMTransactionObject.csmParam_Transactiontype_proceedoninsufficentfunds(),
					CSMTransactionObject.csmParam_Transactiontype_proceedoninsufficentfunds());
			clicksAndActionsHelper
...
//TRS_110
	...
	public void user_enter_value_with_WithdrawLimit_in_limits() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimits());

		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimits());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimits());
		CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimits()
				.sendKeys(testData.get("WithdrawLimit"));
	...
	public void user_enter_value_with_WithdrawLimit_no2__in_limits() throws Throwable {
		try {
			seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
					CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimitsNo2());
	...
	public void user_enter_the_transaction_type_no2__in_limits() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx());

		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx());
		CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx()
				.sendKeys(testData.get("TRXType_D2"));
	...
	public void user_retrive_the_existing_record_no2_from_the_limits_screen() throws Throwable {
		...
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.limits_retriveTheRecord_DataNo2());
	...
	public void user_retrive_the_existing_record_forTRS115_from_the_limits_screen() throws Throwable {
		...
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.limits_retriveTheRecordtoDelete());
	}
	...
	public void user_retrive_the_existing_record_forTRS110_from_the_limits_screen() throws Throwable {
		...
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.limits_retriveTheRecordfor_TRS110());

		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.limits_retriveTheRecordfor_TRS110());
		javascriptHelper.scrollIntoView(CSMTransactionObject.limits_retriveTheRecordfor_TRS110());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.limits_retriveTheRecordfor_TRS110());
...
//TRS_111
	...
	public void user_click_the_limit_button_in_update_after_approve_screen() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits());
	}

	@And("^user  click add button under Limits$")
	public void user_click_add_button_under_limits() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn());
		seleniumActions.getJavascriptHelper()
				.scrollIntoView(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency());
	...
	public void user_enter_the_value_of_currency_in_limits() throws Throwable {
		...
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency());
		seleniumActions.getJavascriptHelper()
				.scrollIntoView(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency());
		CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_currency()
				.sendKeys(testData.get("CurrencyCode_D1"));
	...
	public void user_enter_the_transaction_type_in_limits() throws Throwable {
		...
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx());
		CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx()
				.sendKeys(testData.get("TRXType_D1"));
		CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_Trx().sendKeys(Keys.TAB);
		// seleniumActions.getJavascriptHelper().scrollIntoView(CSMTransactionObj.csm_sysparam_user_updateafterapprove_Limits_addbtn_WDLimits());
	}
	...
	public void user_enter_value_with_DepositLimitno1_in_limits() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.depositLimitInUpdateAfterApprove());

		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.depositLimitInUpdateAfterApprove());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.depositLimitInUpdateAfterApprove());
	...
	public void user_check_the_with_warnuserlimit_in_limit() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_warnuserlimit_check());
		seleniumActions.getClickAndActionsHelper().moveToElement(
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_warnuserlimit_check());
	...
	public void user_check_the_with_proceediflimit_in_limit() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_proceediflimit_check());
		seleniumActions.getClickAndActionsHelper().moveToElement(
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_proceediflimit_check());
		seleniumActions.getJavascriptHelper().scrollIntoView(
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_proceediflimit_check());
	...
	public void user_click_the_ok_button_under_limit() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_ok());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_ok());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.csm_sysparam_user_updateafterapprove_Limits_addbtn_ok());
	}

	@And("^User Enter the Date in User Running Dates$")
	public void user_enter_the_date_in_user_running_dates() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.CSMDateInUserRunningDate());
	...
	public void user_retrive_the_existing_record_from_the_limits_screen() throws Throwable {
		try {
			seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
					CSMTransactionObject.limits_retriveTheRecord());
...
//TRS_127
	...
	public void user_click_the_branch_manager_account_in_the_alert_popup() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.Transaction_maintanance_alertclickingUserId());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.Transaction_maintanance_alertclickingUserId());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.Transaction_maintanance_alertclickingUserId());
	}

	@Then("user click the send button in Alert popup")
	public void user_click_the_send_button_in_alert_popup() throws Throwable {
		seleniumActions.getWaitHelper().waitForElementwithFluentwait(driver,
				CSMTransactionObject.Transaction_maintanance_alertclickingUserId_SendBtn());
		seleniumActions.getClickAndActionsHelper()
				.moveToElement(CSMTransactionObject.Transaction_maintanance_alertclickingUserId_SendBtn());
		seleniumActions.getClickAndActionsHelper()
				.clickOnElement(CSMTransactionObject.Transaction_maintanance_alertclickingUserId_SendBtn());
	}
	...
	public void user_click_control_record_sub_menu_under_system_parameter() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.SystemParameters_ControlRecord_606());
		for (int i = 0; i < 200; i++) {
			
			try {
				javascriptHelper.scrollIntoView(CSMTransactionObject.SystemParameters_ControlRecord_606());
				//clicksAndActionsHelper.moveToElement(CSMTransactionObject.SystemParameters_ControlRecord_606());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.SystemParameters_ControlRecord_606());
				break;	
			} catch (Exception e) {
				  if (i==199) {
	                    Assert.fail(e.getMessage());
	...
	public void user_click_upa_under_control_record() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.SystemParameters_ControlRecord_UPA_606());
		for (int i = 0; i < 200; i++) {
			try {
				clicksAndActionsHelper.moveToElement(CSMTransactionObject.SystemParameters_ControlRecord_UPA_606());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.SystemParameters_ControlRecord_UPA_606());
				break;
			} catch (Exception e) {
			Assert.fail(e.getMessage());
			}
	...
	public void user_click_alert_activation_field_under_control_record() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.SystemParameters_ControlRecord_UPA_AlertActivation_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.SystemParameters_ControlRecord_UPA_AlertActivation_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.SystemParameters_ControlRecord_UPA_AlertActivation_606());
		
	}

	@And("user_606 click the AccountBalanceOverdrawnFlag under AlertActivation")
	public void user_click_the_account_balance_overdrawn_flag_under_alert_activation() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_606());
		Thread.sleep(2000);
	...
	public void user_click_the_account_balance_overdrawnfield_under_alert_activation() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_606());
	...
	public void user_check_the_account_balance_overdrawn_check_box_under_alert_activation() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_Checkbox1_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_Checkbox1_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_Checkbox1_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn1_Checkbox1_606());
	}
	...
	public void user_click_the_account_balance_overdrawnfield_under_account_balance_overdrawn_flag() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_606());
	}
	...
	public void user_check_the_account_balance_overdrawn_check_box_under_account_balance_overdrawn_flag() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_CheckBox2_606());		
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_CheckBox2_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_flag_AccountBalanceOverdrawn2_CheckBox2_606());
		
	}

	@And("user_606 click the UPA button under ControlRecord")
	public void user_click_the_upa_button_under_control_record() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_UPAButton_606());
		javascriptHelper.scrollIntoView(CSMTransactionObject.ControlRecord_UPA_AlertActivation_UPAButton_606());
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_UPAButton_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_UPAButton_606());
	...
	public void user_click_the_approve_field_under_control_record() {
		...
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_606());
		
				javascriptHelper.scrollIntoView(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_606());
				clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_606());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_606());
	...
	public void user_click_the_approve_button_under_control_record() {
		...
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_ApproveButton_606());
		javascriptHelper.scrollIntoView(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_ApproveButton_606());
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_ApproveButton_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecord_UPA_AlertActivation_ApproveField_ApproveButton_606());
	}
	
	//TRS_140
	@And("^user update test data set id for TRS_140$")
	public void user_update_test_data_set_id_for_trs140() throws Throwable {
		testData = excelDataForTransaction.getTestdata("TRS_140_D1");
	}

	@And("^User get Transaction number from success pop up forTRS_140$")
	public void user_get_transaction_number_from_success_pop_up_forTRS_140() throws Throwable {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.getTransactionNumber());
		String transactionNo = CSMTransactionObject.getTransactionNumber().getText().substring(15, 19);
		System.out.println(transactionNo);
		excelDataForTransaction.updateTestData("TRS_140_D1", "TRXNo", transactionNo);
		testData = excelDataForTransaction.getTestdata("TRS_140_D1");
	}
	
	@And("user_606 click the EnableMultiBranch checkbox")
	public void user_click_the_enable_multi_branch_checkbox() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.SystemParameters_TransactionType_UPA_EnableMultiBranchCkeckbox_606());
		javascriptHelper.scrollIntoView(CSMTransactionObject.SystemParameters_TransactionType_UPA_EnableMultiBranchCkeckbox_606());
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.SystemParameters_TransactionType_UPA_EnableMultiBranchCkeckbox_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.SystemParameters_TransactionType_UPA_EnableMultiBranchCkeckbox_606());
	    
	}

	@And("user_606 click the InterbranchEntry Alert flag")
	public void user_click_the_interbranch_entry_alert_flag() {
		
	    
	}

	@And("user_606 click the InterBranchEntry field")
	public void user_click_the_inter_branch_entry_field() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_606());
		//javascriptHelper.scrollIntoView(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_606());
		clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_606());
		clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_606());
	    
	}

	@And("user_606 click the InterBranchEntry checkbox")
	public void user_click_the_inter_branch_entry_checkbox() {
		waitHelper.waitForElementwithFluentwait(driver, CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_checkBox_606());
		for (int i = 0; i < 200; i++) {
			try {
				//javascriptHelper.scrollIntoView(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_606());
				clicksAndActionsHelper.moveToElement(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_checkBox_606());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_checkBox_606());
				clicksAndActionsHelper.clickOnElement(CSMTransactionObject.ControlRecords_UPA_AlertActivation_AccountBalanceoverdrawn_intraBranch_checkBox_606());
				break;
			} catch (Exception e) {
				  if (i==199) {
